        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <!-- Starting of Dashboard projects data-table area -->
                                            ...
                                            @foreach($projects as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:;" data-href="{{url('/')}}/admin/project/{{$project->id}}/delete" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Delete</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                    ...
                    <!-- Ending of Dashboard projects data-table area -->
