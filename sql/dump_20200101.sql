...
-- Exportiere Datenbank Struktur für helpme_lu_de_relaunch
CREATE DATABASE IF NOT EXISTS `helpme_lu_de_relaunch` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `helpme_lu_de_relaunch`;

-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.admin
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.admin: ~3 rows (ungefähr)
DELETE FROM `admin`;
...
INSERT INTO `admin` (`id`, `name`, `username`, `email`, `phone`, `country`, `password`, `role`, `photo`, `created_at`, `updated_at`, `remember_token`, `status`) VALUES
	(1, 'Genius Admin', 'admin', 'admin@gmail.com', '0111111111', 'Bahamas', '$2y$10$IqHFJevSztLR7RpeINrZCuMfSZi0XDY4Pyxu3Pfh5bMfmz3rCnMtO', 'administrator', '1491825290645x430-film-animasi-larrikins-borong-bintang-bintang-australia-160604k.jpg', '2017-01-24 03:21:40', '2018-10-21 15:38:19', 'UsgvSKaU8iQxyKDi8uNklxJSXwom4kpo3ccrzowGB4Ah7iaJDCdiUhxOS6De', 1),
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.advertisements
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.advertisements: ~0 rows (ungefähr)
DELETE FROM `advertisements`;
/*!40000 ALTER TABLE `advertisements` DISABLE KEYS */;
/*!40000 ALTER TABLE `advertisements` ENABLE KEYS */;

-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.blogs
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.blogs: ~4 rows (ungefähr)
DELETE FROM `blogs`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.brands
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.brands: ~9 rows (ungefähr)
DELETE FROM `brands`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.campaigns
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.campaigns: ~5 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.category
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.category: ~8 rows (ungefähr)
DELETE FROM `category`;
/*!40000 ALTER TABLE `category` DISABLE KEYS */;
INSERT INTO `category` (`id`, `name`, `slug`, `image`, `status`) VALUES
	(19, 'Geldspenden', 'geldspenden', 'i7Wgeldspende.jpg', 1),
	(21, 'Kurban', 'kurban', 'pTbkurban.jpg', 1),
	(22, 'Ramadan', 'ramadan', 'Ve6ramadan.jpg', 1),
	(23, 'Bildung', 'bildung', 'sPSbildung.jpg', 1),
	(25, 'Wasserversorgung', 'wasserversorgung', '2fTbrunnen.jpg', 1),
	(26, 'Waisenkinder', 'waisenkinder', 'ePDwaisenkinder.jpg', 1),
	(27, 'Lebensmittel', 'lebensmittel', '1ZIlebensmittel.jpg', 1),
	(28, 'Humanitär', 'humanitaer', 'vQ0humanitarian.jpg', 1);
/*!40000 ALTER TABLE `category` ENABLE KEYS */;

-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.code_scripts
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.code_scripts: ~0 rows (ungefähr)
DELETE FROM `code_scripts`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.counter
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.counter: ~11 rows (ungefähr)
DELETE FROM `counter`;
...
INSERT INTO `counter` (`id`, `type`, `referral`, `total_count`, `todays_count`, `today`) VALUES
	...
	(3, 'browser', 'Windows 10', 759, 0, NULL),
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.country
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.country: 238 rows
DELETE FROM `country`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.donations
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.donations: ~2 rows (ungefähr)
DELETE FROM `donations`;
/*!40000 ALTER TABLE `donations` DISABLE KEYS */;
INSERT INTO `donations` (`id`, `donation_number`, `campid`, `campby`, `amount`, `anonymous`, `donator_name`, `donator_email`, `donator_phone`, `donator_address`, `donator_city`, `donator_zip`, `donation_method`, `txn_id`, `charge_id`, `donate_date`, `status`) VALUES
	(1, 'As1560679429', 6, 2, 60, 'no', 'Tester', 'tester@gmail.com', '0123456789', 'aaa 111m 1 12323 12', 'LU', '67067', 'Paypal', NULL, NULL, '2019-06-16 10:03:49', 'Pending'),
	(2, 'ki1560696474', 1, 1, 30, 'no', 'Erdal Mersinlioglu', 'erdal.mersinlioglu@gmail.com', '491731932880', 'Lindenberger Str., 11', 'Ludwigshafen am Rhein', '67067', 'Paypal', NULL, NULL, '2019-06-16 14:47:54', 'Pending');
/*!40000 ALTER TABLE `donations` ENABLE KEYS */;

-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.faqs
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.faqs: ~4 rows (ungefähr)
DELETE FROM `faqs`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.gallery_images
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.gallery_images: ~14 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.page_settings
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.page_settings: ~0 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.portfolios
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.portfolios: ~6 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.project
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.project: ~0 rows (ungefähr)
DELETE FROM `project`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.section_titles
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.section_titles: ~0 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.service_section
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.service_section: ~6 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.settings
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.settings: ~0 rows (ungefähr)
...
INSERT INTO `settings` (`id`, `logo`, `favicon`, `title`, `url`, `about`, `address`, `phone`, `fax`, `email`, `footer`, `background`, `currency_sign`, `currency_code`, `paypal_business`, `stripe_key`, `stripe_secret`, `success_msg`, `withdraw_charge`, `paypal_donate`, `stripe_donate`, `anonym_donation`, `theme_color`, `css_file`) VALUES
	(1, 'logo1.png', 'favicon.ico', 'charity', 'Fuckcccccc', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae&nbsp;', '124/6 Street, Country', '00 000 000 000', '00 000 000 000', 'admin@geniusocean.com', 'COPYRIGHT 2019 <a href="http://geniusocean.com">GeniusOcean.com<br></a>', 'smm-min2.jpg', '$', 'USD', 'info@helpme-lu.de', 'pk_test_bD5Si0msHNV75sd5R71jSJFb', 'sk_test_r7zxASOuYYCiuT3svkUtuh6W', '<h1 class="text-center" style="color: green">Payment Success.<br> Thank You !!</h1>\n                        <h2>Your Donation Received Successfully.</h2>', 10, 1, 1, 0, '#00affa', 'genius1.css');
/*!40000 ALTER TABLE `settings` ENABLE KEYS */;

-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.site_language
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.site_language: ~0 rows (ungefähr)
DELETE FROM `site_language`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.sliders
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.sliders: ~3 rows (ungefähr)
DELETE FROM `sliders`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.social_links
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.social_links: ~0 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.split_section
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.split_section: ~3 rows (ungefähr)
DELETE FROM `split_section`;
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.subscription
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.subscription: 2 rows
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.testimonials
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.testimonials: ~2 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.user_profiles
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.user_profiles: 3 rows
...
INSERT INTO `user_profiles` (`id`, `name`, `gender`, `phone`, `fax`, `email`, `password`, `country`, `address`, `city`, `zip`, `created_at`, `updated_at`, `remember_token`, `status`) VALUES
	(2, 'User Name', NULL, '2222256474', '324344', 'user@gmail.com', '$2y$10$IqHFJevSztLR7RpeINrZCuMfSZi0XDY4Pyxu3Pfh5bMfmz3rCnMtO', 'Argentina', 'sss', 'ssss', 'ssss', '2017-05-04 11:59:39', '2018-01-09 17:03:42', 'LUW3pzNOZh06ClQf5PL8XQXcTCMFtR4yLb806VjNhyGNY93as2RSNzc5t2Tf', 1),
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.volunteers
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.volunteers: ~4 rows (ungefähr)
...
-- Exportiere Struktur von Tabelle helpme_lu_de_relaunch.withdraws
...
-- Exportiere Daten aus Tabelle helpme_lu_de_relaunch.withdraws: ~0 rows (ungefähr)
